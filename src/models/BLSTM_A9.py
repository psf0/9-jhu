...
from src.features.features_functions import (
    load_dataset_5_train, load_dataset_4_val, transform_tf, feature_transform_0,
    SubsetSampler, shuffle_cycle_dataset)
from src.features.mask_functions import ideal_phase_sensitive_target
...
# training using a phase sesitive masks
p = {
    'experiment_name': 'BLSTM_A9',
    'model_class': BLSTM_A,
    ...
    'training_set': load_dataset_5_train,
    'validation_set': load_dataset_4_val,
    'batch_size': 10,
    'epochs_max': 57,
    'samples_per_epoch': 21384,  # length of dataset_3 and 4
