...
from src.features.features_functions import (
    load_dataset_2_train, load_dataset_2_val, transform_tf, feature_transform_0,
...
# larger dataset than A0
p = {
    'experiment_name': 'BLSTM_A2',
    'model_class': BLSTM_A,
    ...
    'input_transform': transform_tf(
        feature_transform_0(os.path.join('data', 'processed', 'dataset_2')),
        ideal_amplitude_target),
    'output_transform': apply_mask,
    'training_set': load_dataset_2_train,
    'validation_set': load_dataset_2_val,
    'batch_size': 10,
    'epochs_max': 27,
