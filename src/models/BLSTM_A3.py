...
from src.features.features_functions import (
    load_dataset_3_train, load_dataset_3_val, transform_tf, feature_transform_0,
...
# Using lre as train not only english
p = {
    'experiment_name': 'BLSTM_A3',
    'model_class': BLSTM_A,
    ...
    'input_transform': transform_tf(
        feature_transform_0(os.path.join('data', 'processed', 'dataset_3')),
        ideal_amplitude_target),
    'output_transform': apply_mask,
    'training_set': load_dataset_3_train,
    'validation_set': load_dataset_3_val,
    'batch_size': 10,
    'epochs_max': 27,
