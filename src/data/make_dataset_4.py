...
#    output_dir a = Path('.') / 'data' / 'processed' / 'dataset_1'
    ...
    validation_set = Data_synthesis_1(
        length=test_len, test=True, speech_list='lre_train', noise_version=2)
...
if __name__ == '__main__':
    dataset_dir = os.path.join(*['data', 'processed', 'dataset_4'])

    make_dataset_4(dataset_dir)
